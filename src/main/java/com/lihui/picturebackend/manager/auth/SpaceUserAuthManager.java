package com.lihui.picturebackend.manager.auth;

import cn.hutool.core.io.resource.ResourceUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import com.lihui.picturebackend.manager.auth.model.SpaceUserAuthConfig;
import com.lihui.picturebackend.manager.auth.model.SpaceUserPermissionConstant;
import com.lihui.picturebackend.manager.auth.model.SpaceUserRole;
...
public class SpaceUserAuthManager {
    ...
    public List<String> getPermissionList(Space space, User loginUser) {
        ...
        //超级管理员权限
        List<String> SU_ADMIN_PERMISSIONS = getPermissionsByRole(SpaceRoleEnum.SU_ADMIN.getValue());
        // 公共图库
        if (space == null) {

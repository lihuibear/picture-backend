package com.lihui.picturebackend.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private Set<String> fetchAllPictureTableNames() {
        ...
        Set<Long> spaceIds = spaceService.lambdaQuery().eq(Space::getSpaceType, SpaceTypeEnum.TEAM.getValue()).list().stream().map(Space::getId).collect(Collectors.toSet());
    ...
    private void updateShardingTableNodes() {
        ...
        String newActualDataNodes = tableNames.stream().map(tableName -> "picture." + tableName) // 确保前缀合法

...
import com.lihui.picturebackend.api.aiyunai.model.CreateOutPaintingTaskRequest;
...
import com.lihui.picturebackend.manager.CosManager;
import com.lihui.picturebackend.manager.FileManager;
import com.lihui.picturebackend.manager.upload.FilePictureUpload;
import com.lihui.picturebackend.manager.upload.PictureUploadTemplate;
import com.lihui.picturebackend.manager.upload.UrlPictureUpload;
import com.lihui.picturebackend.mapper.PictureMapper;
import com.lihui.picturebackend.model.dto.file.UploadPictureResult;
...
import com.lihui.picturebackend.utils.ColorSimilarUtils;
import com.lihui.picturebackend.utils.ColorTransformUtils;
...
public class PictureServiceImpl extends ServiceImpl<PictureMapper, Picture>
    ...
    public PictureVO uploadPicture(Object inputSource, PictureUploadRequest pictureUploadRequest, User loginUser) {
        ...
        if (pictureId != null) {
            ...
            // 校验空间是否一致
            // 没传 spaceId，则复用原有图片的 spaceId（这样也兼容了公共空间）
            if (spaceId == null) {
...
//        ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR, "图片上传失败");
    ...
    public Integer uploadPictureByBatch(PictureUploadByBatchRequest pictureUploadByBatchRequest, User loginUser) {
        ...
        String categoryName = pictureUploadByBatchRequest.getCategory();
...
//            PictureUploadRequest pictureUploadRequest = new PictureUploadRequest();
            ...
            if (StrUtil.isNotBlank(namePrefix)) {
                ...
                pictureUploadRequest.setCategory(categoryName);
            }
            try {
    ...
    public void clearPictureFile(Picture oldPicture) {
        ...
        try {
            ...
            log.error("error url.img URL: {}", pictureUrl, e);
